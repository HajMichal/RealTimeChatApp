  ...
  return (
    <div className="w-full flex justify-center bg-dark tablet:bg-light h-screen">
      <div className="bg-dark desktop:w-1/3 tablet:h-min tablet:mt-16 max-w-md ">
        ...
        <form action="POST" onSubmit={handleSubmit(submitForm)} className="w-full p-3 flex flex-wrap justify-center">
          <div className="form-control w-full max-w-xs">
            <label className="label">
              <span className="label-text">What is your name?</span>
            </label>
            <input
            {...register("name", { required: { value: true, message: "Field required"}})}
              type="text"
        ...
        <div>
          <fieldset className="border-t-2 border-mid mx-10">
            ...
            <div className="w-full pt-4 text-center text-mid font-medium text-lg mb-8">
              <Link to="/login" className="hover:text-light">Log in!</Link>
            </div>
          </fieldset>
        </div>
      </div>
